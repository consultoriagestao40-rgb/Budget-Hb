...
export function MultiSelect({
    ...
    return (
        <div className="flex flex-col gap-0.5 min-w-[150px] flex-1 relative" ref={containerRef}>
            <label className="text-[10px] font-semibold text-[var(--text-muted)] uppercase tracking-wider px-0.5">{label}</label>
            ...
            <button
                ...
                disabled={disabled}
                className={`
                    w-full flex items-center justify-between px-2.5 py-1.5 text-sm rounded-md border 
